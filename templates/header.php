...
$server = 'http://' . $_SERVER['SERVER_NAME'] . '/akings/';
		...
		<div class="navbar-collapse collapse justify-content-between">
			<ul class="navbar-nav" id="navbar">
				<li class="nav-item active">
					<a class="nav-link text-dark" href="<?php echo $server; ?>index.php"><i class="fa fa-shopping-basket text-dark"></i> Aking's Sari-sari</a>
				</li>
